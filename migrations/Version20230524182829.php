 ...
 */
final class Version20230524182829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD synopsis VARCHAR(255) NOT NULL, ADD year INT NOT NULL, CHANGE poster poster VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program DROP synopsis, DROP year, CHANGE poster poster VARCHAR(255) NOT NULL');
